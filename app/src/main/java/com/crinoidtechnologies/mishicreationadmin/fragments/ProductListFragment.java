...
public class ProductListFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        productDataList.add( new ProductData( "100", R.drawable.logo ) );
        productDataList.add( new ProductData( "200", R.drawable.logo ) );
        productDataList.add( new ProductData( "300", R.drawable.logo ) );
        productDataList.add( new ProductData( "400", R.drawable.logo ) );
        productDataList.add( new ProductData( "500", R.drawable.logo ) );
